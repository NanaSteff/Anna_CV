...
\newcommand{\drawBaner}{%
	\begin{tikzpicture}[remember picture, overlay]
		\fill[banerColor] (-30pt,30pt) rectangle (\paperwidth,-0.10\paperheight);
	\end{tikzpicture}%
}
...
\cvWP{Currently}{Berlekamp-Massey Algorithm \link{https://github.com/NanaSteff/Berlekamp_Massey_Algorithm}}{Personal project}{An implementation of the Berlekamp-Massey Algorithm  written in Python3.}
